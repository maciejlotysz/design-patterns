package factory.example.abstractfactory;

import factory.example.abstractfactory.units.*;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.asList(redTank, redInfantry, redHelicopter));
        System.out.println("Blue team: ");
        System.out.println(Arrays.asList(blueTank, blueInfantry, blueHelicopter));
    }
}
